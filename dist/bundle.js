...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   fetchWeather: () => (/* binding */ fetchWeather)\n/* harmony export */ });\n/* harmony import */ var _dailyInfo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dailyInfo */ \"./src/modules/dailyInfo.js\");\n/* harmony import */ var _weatherInfo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weatherInfo */ \"./src/modules/weatherInfo.js\");\n\n\n\nasync function fetchWeather(searchTerm = \"aveiro\") {\n  let link = `https://api.weatherapi.com/v1/current.json?key=6faa5075dd9445cfb4c215331240207&q=${searchTerm}`;\n\n  try {\n    let response = await fetch(link, { mode: \"cors\" });\n    let data = await response.json();\n    console.log(data);\n    (0,_dailyInfo__WEBPACK_IMPORTED_MODULE_0__.displayDailyInfo)(data);\n    (0,_weatherInfo__WEBPACK_IMPORTED_MODULE_1__.weatherInfo)(data);\n  } catch (error) {\n    console.error(\"Error fetching the weather:\", error);\n  }\n}\n\n\n\n\n//# sourceURL=webpack://weather-app/./src/modules/fetchWeather.js?");
